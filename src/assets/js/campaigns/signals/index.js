...
export const S_CAMPAIGN_SELECT_S_CAMPAIGN_TYPE = 'S_CAMPAIGN_SELECT_S_CAMPAIGN_TYPE';
...
export const campaignSelectCampaignType = createAction(S_CAMPAIGN_SELECT_S_CAMPAIGN_TYPE);
